...
{
    using global::WebApplication1.Application.Queries;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Doctor.Web", Version = "v1" });
            });
            services.AddSingleton<IDocotorRepository, DoctorRepository>();
